...
class DoorButton(Device):
    ...
    door = models.OneToOneField(Door, related_name='doorbuttons', on_delete=models.CASCADE, editable=False)
...
class ButtonValue(TimescaleModel):
    ...
    def __str__(self):
        return ('Cabinet: '+self.doorbutton.door.rack.cabinet.profinet_name+', Rack: '+self.doorbutton.door.rack.name + ', Door: '+ self.doorbutton.door.direction)
