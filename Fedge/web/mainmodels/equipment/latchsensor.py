...
class LatchSensor(Device):
    ...
    door = models.OneToOneField(Door, related_name='latchsensors', on_delete=models.CASCADE, editable=False)
    ...
    def save(self, *args, **kwargs):
        ...
        super(LatchSensor, self).save(*args, **kwargs)
