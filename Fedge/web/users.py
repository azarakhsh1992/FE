...
class User(AbstractBaseUser): #on_delete = CASCADE
    ...
    accessible_cabinets = models.CharField (max_length=500, null=True, editable=False)
    ...
    def save (self, *args, **kwargs):
        if self.role == "TECHNICIAN":
            self.accessible_cabinets ='PS'
        elif self.role == "PLANT_OPERATOR" :
            self.accessible_cabinets = ['PS', 'NETWORK']
            
        elif self.role == "IT_SHOPFLOOR":
            self.accessible_cabinets = ['FE','NETWORK']
