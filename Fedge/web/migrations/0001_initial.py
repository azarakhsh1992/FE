# Generated by Django 4.2.3 on 2023-11-21 12:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.CharField(choices=[('group1', 'Group 1'), ('group2', 'Group 2'), ('group3', 'Group 3'), ('group4', 'Group 4')], default=None, max_length=10, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Rack',
        ...
        migrations.AddField(
            model_name='device',
            name='rack',
            field=models.ForeignKey(editable=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='web.rack'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.employeegroup')),
                ('shift', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.shifts')),
            ],
            options={
