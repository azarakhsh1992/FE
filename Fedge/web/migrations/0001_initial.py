# Generated by Django 4.2.3 on 2023-11-05 18:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funktionseinheit', models.CharField(help_text='it must have at least three character', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profinet_name', models.CharField(default=None, editable=False, max_length=22, unique=True)),
                ...
                ('port', models.CharField(choices=[('P1', 'P1'), ('P2', 'P2'), ('P3', 'P3'), ('P4', 'P4'), ('P5', 'P5'), ('P6', 'P6'), ('P7', 'P7'), ('P8', 'P8'), ('P9', 'P9'), ('P10', 'P10'), ('P11', 'P11'), ('P12', 'P12'), ('P13', 'P13'), ('P14', 'P14'), ('P15', 'P15'), ('P16', 'P16')], default=None, max_length=4)),
            ],
        ),
        migrations.CreateModel(
            name='Door',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('direction', models.CharField(choices=[('Front', 'Front'), ('Rear', 'Rear')], max_length=16)),
        ...
        migrations.AddField(
            model_name='device',
            name='plc',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='device', to='web.plc'),
        ),
        migrations.CreateModel(
