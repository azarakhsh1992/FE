# Generated by Django 4.2.3 on 2023-11-07 11:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plc_name', models.CharField(editable=False, max_length=18)),
                ...
                ('this_module_type', models.CharField(default=None, editable=False, max_length=16)),
                ('door', models.CharField(default=None, editable=False, max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attr1', models.CharField(max_length=16)),
                ('attr2', models.CharField(max_length=16, unique=True)),
                ('attr4', models.CharField(editable=False, max_length=16)),
            ],
        ),
        migrations.CreateModel(
            name='TestP',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attrp3', models.CharField(max_length=16)),
            ],
        ),
        migrations.CreateModel(
            name='Child',
            fields=[
                ('test_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='web.test')),
                ('childattr1', models.CharField(max_length=16)),
            ],
            bases=('web.test',),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='test',
            name='attr3',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.testp'),
        ),
        migrations.CreateModel(
            name='ShiftOfGroup',
            fields=[
        ...
        migrations.AddField(
            model_name='latch',
            name='device_door',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='latch', to='web.door'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('device_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='web.device')),
                ('device_door', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='doorbutton', to='web.door')),
            ],
            bases=('web.device',),
        ),
        migrations.AlterUniqueTogether(
